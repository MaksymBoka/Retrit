...
# in-memory storage for agenda votes: {user_id: {"7": 0 or 1, "8": ..., "9": ...}}
AGENDA_VOTES = {}
...
TEXTS = {
    "uk": {
        ...
        "agenda_intro": "Тепер оберіть план на кожен день ретриту 🗓️",
        ...
        "agenda_header": "📋 Програма ретриту (за результатами голосування):",
    ...
    "ru": {
        ...
        "agenda_intro": "Теперь выберите план на каждый день ретрита 🗓️",
        ...
        "agenda_header": "📋 Программа ретрита (по результатам голосования):",
    ...
    "hy": {
        ...
        "agenda_intro": "Այժմ ընտրեք ծրագիրը ռետրիտի յուրաքանչյուր օրվա համար 🗓️",
        ...
        "agenda_header": "📋 Ռետրիտի ծրագիր (քվեարկության արդյունքով).",
